  ...
  theme: {
    ...
    extend: {
      ...
      keyframes: {
        ...
        "image-reveal": { "0%": { transform: "scale(1.15)", opacity: "0" }, "100%": { transform: "scale(1)", opacity: "1" } },
        "marquee": { "0%": { transform: "translateX(0)" }, "100%": { transform: "translateX(-50%)" } },
        "ken-burns": { "0%": { transform: "scale(1)" }, "100%": { transform: "scale(1.08)" } },
        "float-soft": { "0%, 100%": { transform: "translateY(-33%)" }, "50%": { transform: "translateY(calc(-33% - 12px))" } },
      ...
      animation: {
        ...
        "image-reveal": "image-reveal 1.6s cubic-bezier(0.22, 1, 0.36, 1) both",
